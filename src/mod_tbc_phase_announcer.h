...
{
    "|CFFFFFFFF[TBC PHASE]|r 알 수 없는 페이즈입니다.", // 0번 인덱스는 사용하지 않음
    "|CFFFFFFFF[TBC PHASE]|r 이 서버는 현재 1페이즈 (카라잔, 그룰의 둥지, 마그테리돈의 둥지) 진행중입니다.",
    "|CFFFFFFFF[TBC PHASE||r 이 서버는 현재 2페이즈 (불뱀 제단, 폭풍우 요새) 진행중입니다.",
    "|CFFFFFFFF[TBC PHASE]|r 이 서버는 현재 3페이즈 (하이잘 정상, 검은 사원) 진행중입니다.",
    "|CFFFFFFFF[TBC PHASE]|r 이 서버는 현재 4페이즈 (줄아만) 진행중입니다.",
    "|CFFFFFFFF[TBC PHASE]|r 이 서버는 현재 5페이즈 (태양샘 고원) 진행중입니다."
};
